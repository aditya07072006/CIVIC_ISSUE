...
export default function DepartmentPage() {
  ...
  const handleDeleteIssue = async (issue) => {
    ...
    try {
      ...
      const subDeptId = issue.sub_department_id;
      if (subDeptId) {
        clearSubDeptCaches(subDeptId);
        await fetchSubDepartmentIssues(subDeptId, true);
      }
                                            ...
                                            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                                              ...
                                              <div className="flex flex-col gap-2">
                                                ...
                                                <button
                                                  ...
                                                  className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-rose-200 bg-rose-50 px-4 py-2.5 text-sm font-semibold text-rose-700 transition-colors hover:bg-rose-100"
                                                >
                                                  <Trash2 size={14} />
                                                  Delete
                                                </button>
          ...
          {detailLoading ? (
            ...
            <div className="space-y-4">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                ...
                <h3 className="mt-2 text-base font-semibold text-slate-900">{issueDetail.title}</h3>
                <p className="mt-2 text-sm text-slate-600">{issueDetail.description || "No description"}</p>
              </div>

              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="rounded-xl border border-slate-200 p-3">
                  <p className="text-xs uppercase tracking-wide text-slate-500">Category</p>
                  <p className="mt-1 font-medium text-slate-900">{issueDetail.category || "-"}</p>
                </div>
                <div className="rounded-xl border border-slate-200 p-3">
